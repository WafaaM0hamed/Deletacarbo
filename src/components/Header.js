    ...
    <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-semibold text-gray-900">Carbon Emission</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* user avatar */}
        <div className="h-9 w-9 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center">
